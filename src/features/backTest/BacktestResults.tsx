...
const BacktestResults: React.FC<BacktestResultsProps> = ({
  ...
  const calculateROI = () => {
    // Assumindo capital inicial de $10,000 para demonstração
                        ...
                        {result.trades.map((trade, index) => {
                          ...
                          return (
                            <TableRow 
                              key={index}
                              sx={{ 
                                backgroundColor: isWin ? 'rgba(76, 175, 80, 0.05)' : 'rgba(244, 67, 54, 0.05)',
                                '&:hover': { backgroundColor: isWin ? 'rgba(76, 175, 80, 0.1)' : 'rgba(244, 67, 54, 0.1)' }
                              }}
                            >
